...
Covers worksheet (sheet) protection read/write via `<sheetProtection>`,
mirroring ExcelJS `ws.protection = { locked, selectLockedCells, ... }`. Workbook-level
protection is out of scope for this capability.
